    ...
    <div className="w-full">
      <Navbar fluid rounded className="bg-gray-800 dark:bg-gray-800">
          ...
          <NavbarCollapse>
            ...
            <NavbarLink as={Link} href="https://github.com/bwbayu" className="text-lg">
              <i className="devicon-github-original"></i>
            </NavbarLink>
            <NavbarLink as={Link} href="https://www.linkedin.com/in/bayu-wicaksono-6a4b722a2" className="text-lg">
              <i className="devicon-linkedin-plain"></i>
            </NavbarLink>
            <NavbarLink as={Link} href="https://huggingface.co/bwbayu" className="text-lg">
              <Image
                src="/huggingface.png"
